...
public class Beans {
    ...
    private static Object internalInstantiate(ClassLoader cls, String beanName) throws IOException,
    ...
    public static Object instantiate(ClassLoader loader, String name)
        ...
        return internalInstantiate(loader, name);
    }
    ...
    public static boolean isInstanceOf(Object bean, Class<?> targetType) {
        ...
        return targetType != null && targetType.isInstance(bean);
    }
