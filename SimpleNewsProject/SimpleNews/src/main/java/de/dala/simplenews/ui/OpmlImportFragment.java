 ...
 */
public class OpmlImportFragment extends Fragment implements ContextualUndoAdapter.DeleteItemCallback {
    ...
    public static OpmlImportFragment newInstance(ArrayList<Feed> feedsToImport) {
        OpmlImportFragment fragment = new OpmlImportFragment();
        Bundle b = new Bundle();
        b.putSerializable(FEED_LIST_KEY, feedsToImport);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        feedsToImport = (ArrayList<Feed>)savedInstanceState.getSerializable(FEED_LIST_KEY);
        initAdapter();
