 ...
 */
public class SwipeRefreshLayoutExtended extends ViewGroup {
     ...
     * @param context
     */
    public SwipeRefreshLayoutExtended(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwipeRefreshLayoutExtended(Context context, AttributeSet attrs) {
        super(context, attrs);
