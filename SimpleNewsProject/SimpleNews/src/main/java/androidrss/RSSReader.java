...
public class RSSReader implements java.io.Closeable {
  ...
  /**
   * Thread-safe {@link org.apache.http.client.HttpClient} implementation.
   */
   ...
   * {@link org.apache.http.client.HttpClient} implementation must be thread-safe.
   * 
  ...
  /**
   * Instantiate a thread-safe HTTP client to retrieve RSS feeds. The injected
   * {@link org.apache.http.client.HttpClient} implementation must be thread-safe. Internal memory
