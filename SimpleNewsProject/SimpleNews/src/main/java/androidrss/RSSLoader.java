 ...
 * </ul>
 * <p/>
 * Completed RSS feed loads can be retrieved with {@link androidrss.RSSLoader#take()},
 * {@link androidrss.RSSLoader#poll()} or {@link androidrss.RSSLoader#poll(long, java.util.concurrent.TimeUnit)}.
 * <p/>
 * <p>
 * <b>Usage Example</b>
 * <p/>
...
public class RSSLoader {
     ...
     * {@link java.util.concurrent.BlockingQueue} implementation determines the load behaviour.
     *
     ...
     * Create an object which can load RSS feeds asynchronously in FIFO order.
     *
     * @param capacity expected number of URIs to be loaded at a given time
     */
     ...
     *
     * @return the {@link java.util.concurrent.Future} representing the loaded RSS feed
     ...
     *
     * @return the {@link java.util.concurrent.Future} representing the loaded RSS feed, or
     ...
     * @param unit    a {@link java.util.concurrent.TimeUnit} determining how to interpret the
